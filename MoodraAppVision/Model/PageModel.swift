...
struct Page: Identifiable, Equatable {
    ...
    static var pages : [Page] = [
        ...
        Page(name: "A full immersion experience", description: "Choose your favourite relaxing sound and background to enjoy your dynamic meditation!", image: "Main", tag: 3)
    ]
