...
class CameraViewController: RecorderViewController {
    ...
    private let label = UILabel(frame: CGRect(x: 100, y: 100, width: 500, height: 100))
    ...
    override func viewDidLoad() {
        ...
        startButton.widthAnchor.constraint(equalTo: view.widthAnchor, multiplier: 1 / 3).isActive = true
    ...
    func processPoints(fingers: PossibleFingers) {
        ...
        currentGesture = gestureProcessor.processFingerPoints(fingers)
         */
    }
    ...
    private func handleGestureStateChange(state: ApprovalGestureProcessor.State) {
        ...
        case .possibleThumbsUp, .possibleThumbsDown:
            ...
            label.text = ""
        case .thumbsUp:
            tipsColor = .systemMint
            label.text = "👍"
        case .pataka:
            tipsColor = .systemMint
            label.text = "Pataka"
        case .thumbsDown, .unknown:
            tipsColor = .systemPurple
            label.text = "👎"
            
            label.text = currentGesture
        }
